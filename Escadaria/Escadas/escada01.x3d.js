function escada01(attr){ 	
	return "\n\
	\
	<!--<Group DEF='Escada'>-->\n\
			<Transform >\n\
					<!--<Inline DEF='PrimeiroDegrau' url='Degraus/primeiroDegrau.x3d'/>-->\n\
			...
			<Transform translation='0.77 0.0 0.0245'>\n\
					<!-- <Group DEF='Balaustre1' url='../Balaustres/balaustre01.x3d'/> -->\n\
					<prototype use='Balaustre1'></prototype>\n\
			</Transform>\n\
			<Transform translation='0.759 3.438 -4.5' rotation='1.0 0.0 0.0 0.47'>\n\
					<!-- <Group DEF='Corrimao' url='../Corrimaos/corrimao.x3d'/> -->\n\
					<prototype use='Corrimao'></prototype>\n\
			</Transform>\n\
			<Transform translation='-0.69 3.303 -4.1' scale='1.0 1.0 0.95' rotation='1.0 0.0 0.0 0.47'>\n\
				<Group USE='Corrimao'/>\n\
			</Transform>\n\
	<!--</Group>-->\n\
		\
